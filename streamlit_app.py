...
# Attempt to import FAISS and handle the error if not found
try:
    from langchain.vectorstores import FAISS
except ModuleNotFoundError:
    st.error("FAISS module not found. Please ensure you have installed 'faiss-cpu' and 'langchain' packages.")
    st.stop()

st.set_page_config(page_title="PaperPal", layout="wide")

st.markdown("""
## PaperPal: Get instant insights from your Documents
